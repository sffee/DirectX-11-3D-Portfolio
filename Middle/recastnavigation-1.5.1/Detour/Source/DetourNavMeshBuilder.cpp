...
bool dtCreateNavMeshData(dtNavMeshCreateParams* params, unsigned char** outData, int* outDataSize, std::vector<float>& _VtxData)
{
	...
	for (int i = 0; i < params->vertCount; ++i)
	{
		...
		_VtxData.push_back(v[0]);
		_VtxData.push_back(v[1]);
		_VtxData.push_back(v[2]);
	}
